...
const HotProducts = () => {
  return (
    <div className="px-12 mt-12 pb-5">
      ...
      <div className="w-[300px] rounded-xl bg-white shadow-md hover:shadow-xl transition-transform cursor-pointer">
        <div className="relative">
          ...
          <div className="absolute top-3 left-3 bg-red-500 rounded text-white px-2 py-1 font-bold">Giảm 10%</div>
          <div className="absolute top-3 right-3  bg-violet-500 rounded text-white px-2 py-1 text-xs font-bold">HOT</div>
        </div>
        <div className="p-2">
